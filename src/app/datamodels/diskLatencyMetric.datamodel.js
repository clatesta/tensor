 ...
 */
 ...
 (function() {
    ...
    * @desc
    */
    function DiskLatencyMetricDataModel(WidgetDataModel, MetricListService, TensorService) {
                            ...
                            if (angular.isDefined(rawactiveInstance)) {
                                if (instance.values.length > 0) {
                                    if (rawactiveInstance.values.length > 0) {
                                        ...
                                        rawactiveLastValue = _.last(rawactiveInstance.values);
                                        if (lastValue.y > 0) {
